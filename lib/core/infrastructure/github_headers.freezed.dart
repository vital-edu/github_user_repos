...
/// @nodoc
@JsonSerializable()
class _$_GithubHeaders implements _GithubHeaders {
  const _$_GithubHeaders({this.etag, this.link});
...
abstract class _GithubHeaders implements GithubHeaders {
...
/// @nodoc
@JsonSerializable()
class _$_PaginationLink implements _PaginationLink {
  const _$_PaginationLink({required this.maxPage});
